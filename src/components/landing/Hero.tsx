      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="bg-primary text-primary-foreground px-8 py-4 rounded-lg transition-all hover:opacity-90 active:scale-[0.98] flex items-center justify-center gap-2 group"
              >
                Start Your Claim Now
                <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} />
              </button>
              <button className="bg-secondary text-secondary-foreground px-8 py-4 rounded-lg transition-all hover:bg-muted active:scale-[0.98] border border-border flex items-center justify-center gap-2">
                <Play size={20} />
                Watch Demo
              </button>
            </div>
          ...
          <div className="relative">
            ...
            {/* Floating stats */}
            <div className="absolute -right-4 -top-4 bg-card border border-border rounded-lg p-4 shadow-card-hover z-10">
              <p className="text-caption text-muted-foreground">Avg. Approval Time</p>
              <p className="text-2xl text-primary">3 mins</p>
            </div>

            <div className="absolute -left-4 -bottom-4 bg-card border border-border rounded-lg p-4 shadow-card-hover z-10">
