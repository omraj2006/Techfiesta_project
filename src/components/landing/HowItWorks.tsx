    ...
    <section id="how-it-works" className="py-16 lg:py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={index} className="relative">
              ...
              <div className="bg-card border border-border rounded-lg p-6 shadow-card hover:shadow-card-hover transition-all h-full">
                ...
                <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${
                  step.color === 'primary' ? 'bg-primary/10 border border-primary/20' :
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex flex-col items-center gap-2 bg-primary/10 border border-primary/20 px-8 py-6 rounded-xl">
            <p className="text-overline text-primary">TOTAL TIME</p>
            <p className="text-4xl text-primary">~5 Minutes</p>
            <p className="text-sm text-muted-foreground">From start to approval</p>
          </div>
        </div>

        {/* CTA */}
        <div className="mt-12 text-center">
          <button className="bg-primary text-primary-foreground px-8 py-4 rounded-lg transition-all hover:opacity-90 active:scale-[0.98]">
