    ...
    <section className="py-16 lg:py-24 bg-gradient-to-b from-transparent to-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 bg-destructive/10 border border-destructive/20 px-6 py-3 rounded-lg">
            <AlertTriangle className="text-destructive" size={20} />
            <p className="text-sm">
              <span className="text-destructive">68% of policyholders</span>
              <span className="text-muted-foreground"> say the claims process is their #1 frustration</span>
            </p>
          </div>
        </div>
      </div>
