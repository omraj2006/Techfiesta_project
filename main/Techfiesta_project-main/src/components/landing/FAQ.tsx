...
export function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Extremely secure. We use bank-grade AES-256 encryption, maintain SOC 2 Type II and ISO 27001 certifications, and are fully compliant with GDPR, HIPAA, and other privacy regulations. Your data is never sold or shared with third parties.'
    },
    {
    ...
    },
    {
      ...
      answer: 'No app installation required! SmartClaim works directly in your web browser on any device (phone, tablet, or computer). However, we do offer optional iOS and Android apps for added convenience and push notifications.'
    },
    {
      question: 'Can I track multiple claims at once?',
      answer: 'Absolutely! Your dashboard shows all active and historical claims in one place. You can track status, view documents, and receive notifications for each claim independently.'
    },
    {
      question: 'What if I need help during the process?',
      answer: 'Our support team is available 24/7 via live chat, email, or phone. We also have extensive help documentation, video tutorials, and an AI assistant that can answer common questions instantly.'
    },
    {
      question: 'How does the OCR document scanning work?',
      answer: 'Simply take a photo of your document (policy, receipts, damage photos, etc.) using your phone camera. Our AI automatically extracts relevant information like policy numbers, dates, amounts, and descriptions—no manual typing needed!'
    },
    {
      question: 'Will my insurance company accept claims filed through SmartClaim?',
      answer: 'Yes! We have direct integrations with over 500 insurance providers. Your claim is submitted directly to your insurance company\'s system in their preferred format. It\'s the same as filing through their portal, just faster and easier.'
    }
  ];
        ...
        <div className="mt-12 text-center">
          <div className="bg-card border border-border rounded-lg p-8 shadow-card">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="bg-secondary text-secondary-foreground px-6 py-3 rounded-lg transition-all hover:bg-muted active:scale-[0.98] border border-border">
                Email Support
              </button>
            </div>
          </div>
